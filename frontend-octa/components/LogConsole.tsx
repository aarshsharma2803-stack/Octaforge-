...
export default function LogConsole() {
  ...
  return (
    <div className="flex flex-col h-full bg-octo-surface border-t border-octo-border w-full">
      ...
      <div 
        ref={scrollRef}
        className="flex-1 overflow-y-auto p-4 font-mono text-[11px] leading-relaxed select-text space-y-1 scrollbar-thin scrollbar-thumb-octo-border scrollbar-track-transparent"
      >
        {filteredLogs.length === 0 ? (
          ...
          filteredLogs.map((log) => {
            ...
            return (
              ...
              >
                <div className="text-slate-500 shrink-0 w-[100px]" suppressHydrationWarning>{time}</div>
